...
const monthlyData = [
  { month: "Jan", transactions: 420, anomalies: 12, matched: 380, pending: 28 },
  { month: "Feb", transactions: 460, anomalies: 15, matched: 410, pending: 35 },
  { month: "Mar", transactions: 518, anomalies: 22, matched: 446, pending: 50 },
  { month: "Apr", transactions: 610, anomalies: 18, matched: 542, pending: 50 },
  { month: "May", transactions: 680, anomalies: 23, matched: 610, pending: 47 },
  { month: "Jun", transactions: 720, anomalies: 30, matched: 650, pending: 40 },
];

const weeklyData = [
  { week: "Week 1", transactions: 180, anomalies: 8, matched: 162, pending: 10 },
  { week: "Week 2", transactions: 165, anomalies: 5, matched: 150, pending: 10 },
  { week: "Week 3", transactions: 190, anomalies: 9, matched: 171, pending: 10 },
  { week: "Week 4", transactions: 185, anomalies: 8, matched: 167, pending: 10 },
];

const dailyData = [
  { day: "Mon", transactions: 38, anomalies: 2, matched: 34, pending: 2 },
  { day: "Tue", transactions: 42, anomalies: 1, matched: 39, pending: 2 },
  { day: "Wed", transactions: 35, anomalies: 0, matched: 33, pending: 2 },
  { day: "Thu", transactions: 29, anomalies: 3, matched: 24, pending: 2 },
  { day: "Fri", transactions: 41, anomalies: 2, matched: 37, pending: 2 },
  { day: "Sat", transactions: 12, anomalies: 0, matched: 10, pending: 2 },
  { day: "Sun", transactions: 8, anomalies: 0, matched: 8, pending: 0 },
];
